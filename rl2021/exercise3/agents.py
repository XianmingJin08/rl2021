    ...
    **YOU NEED TO IMPLEMENT FUNCTIONS IN THIS CLASS**
    ...
    def act(self, obs: np.ndarray, explore: bool):
        ...
        **YOU MUST IMPLEMENT THIS FUNCTION FOR Q3**
        ...
        """
        ### PUT YOUR CODE HERE ###
        # implements a epsilon-greedy action selection
        ...
        # When the value of this boolean flag is
        # True, agents should follow the epsilon-greedy policy
    ...
    def update(self, batch: Transition) -> Dict[str, float]:
        ...
        **YOU MUST IMPLEMENT THIS FUNCTION FOR Q3**
        ...
        """
        ### PUT YOUR CODE HERE ###
        # update the parameters of the value network to minimize Log loss
        self.update_counter += 1
        self.critics_optim.zero_grad()
        criterion = torch.nn.MSELoss()
        (states, actions, next_states, rewards, done) = batch
        q_state_next = self.critics_target(next_states).max(axis=1)[0].detach().unsqueeze(axis=1)
        y = rewards + (1 - done) * self.gamma * q_state_next
    ...
    ** YOU NEED TO IMPLEMENT THE FUNCTIONS IN THIS CLASS **
    ...
    def act(self, obs: np.ndarray, explore: bool):
        ...
        **YOU MUST IMPLEMENT THIS FUNCTION FOR Q3**
        ...
        m = Categorical(probs)
        action = m.sample()
        self.policy_log_probs.append(m.log_prob(action))
        return action.item()
    ...
    def update(
        ...
        **YOU MUST IMPLEMENT THIS FUNCTION FOR Q3**
        ...
        for t in range(T - 1, -1, -1):
            ...
            p_loss -= g * self.policy_log_probs[t]
