...
PENDULUM_CONFIG = {
    ...
    "max_time": 120 * 60,
    "eval_freq": 2000,
    "eval_episodes": 5, #default 5
    "policy_learning_rate": 0.0001, #default 1e-1
    "critic_learning_rate": 0.001, #default 1e-1
    "critic_hidden_size": [400, 300], #default [64,64]
    "policy_hidden_size": [400, 300], #default [64,64]
    "tau": 0.001, #default 0.01
    "batch_size": 64, #default 10
    "gamma": 0.99,
